"""
Missing Nodes Detection Module.

This module provides functions to detect nodes that are referenced in select_from
fields but are not present in the nodes list.
"""
